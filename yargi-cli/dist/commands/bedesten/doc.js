...
export const docCommand = new Command("doc")
    .description("Retrieve full text of a legal decision as Markdown. " +
    ...
    .argument("<documentId>", "Document ID (numeric string) obtained from the 'documentId' field in search results")
    .addHelpText("after", "\nOutput JSON schema:\n" +
    "  {\n" +
