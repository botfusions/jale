...
import { DEFAULT_COURT_TYPES } from '../../types/common.js';
export const searchCommand = new Command('search')
    .description('Search Turkish legal decisions (Yargitay, Danistay, local courts) via Bedesten API. ' +
    'Returns paginated results sorted by decision date (newest first). Output: JSON to stdout.')
    .argument('<phrase>', 'Search query in Turkish. Supported operators:\n' +
    ...
    .option('-c, --court-types <types...>', 'Court type filter. Values:\n' +
    ...
    .option('-b, --chamber <code>', 'Chamber (daire/kurul) filter. Abbreviated codes:\n' +
    ...
    const courtTypes = opts.courtTypes ?? DEFAULT_COURT_TYPES;
    ...
    const searchData = {
        ...
        phrase,
        birimAdi: chamber,
        kararTarihiStart: opts.dateStart ? formatDateStart(opts.dateStart) : undefined,
