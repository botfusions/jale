...
export class BedestenClient extends BaseClient {
  ...
  async searchDocuments(request: BedestenSearchRequest): Promise<BedestenSearchResponse> {
    ...
    return this.post<BedestenSearchResponse>(BedestenClient.SEARCH_ENDPOINT, body);
  }

  async getDocumentAsMarkdown(documentId: string): Promise<BedestenDocumentMarkdown> {
